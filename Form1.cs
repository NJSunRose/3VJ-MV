...
namespace _3VJ_MV
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            #region 设软件小工具版本号V1.4  宋新刚电脑是读取本地D:\模板忽删里的配置文件，其他电脑读取1.20服务器上面的

            string currentversion = "V1.4";
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            foreach (ListViewItem item in listView1.Items)
            {
                ...
                foreach (var str in panel.Edgelist.Where(p => p.Thickness != "0"))  // 20180718
                {
                    i++;
                    if (i == 0)
                        nest.EbW1 = str.Thickness + "mm" + name + "封边条";
                    else if (i == 1)
                        nest.EbW2 = str.Thickness + "mm" + name + "封边条";
                    else if (i == 2)
                        nest.EbL1 = str.Thickness + "mm" + name + "封边条";
                    else if (i == 3)
                        nest.EbL2 = str.Thickness + "mm" + name + "封边条";
                }
